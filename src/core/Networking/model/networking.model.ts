...
export type NetworkingCompanyEffortRowWithSkill = Static<typeof CompanyEffortRowWithSkill>
...
export type NetworkingEffortResponsePerCompanyType = Static<typeof EffortRowPerCompany>

export const NetworkingEffortResponse = Type.Array(NetworkingEffortResponsePerCompany)

export type NetworkingEffortResponseType = Static<typeof NetworkingEffortResponse>